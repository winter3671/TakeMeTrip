    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_season', models.CharField(blank=True, max_length=20)),
                ('usual_duration', models.IntegerField(blank=True, null=True)),
                ('usual_people', models.IntegerField(blank=True, null=True)),
